...
RUN cd nginx-1.9.2/
RUN patch -p1 < /opt/ngx_http_proxy_connect_module/patch/proxy_connect.patch
RUN ./configure --with-http_ssl_module --add-module=/opt/ngx_http_proxy_connect_module/
